...
\setthesisinfoLV
  {Informācijas sistēmu integrācijas brieduma novērtējums projektu vadības birojos: pierādījumi no Latvijas uzņēmumiem}% LV Title
  {Amina Showkath}% LV Student
  {Dr.sc.ing. prof. Andrejs Bondarenko}% LV Supervisor
  {4220 Informācijas sistēmas (bak.)}% LV Study programme
  {Dabaszinātņu un datortehnoloģiju katedra}% LV Department
  {2026}% Year
\setthesisinfoEN
  {Assessment of Information System Integration Maturity in Project Management Offices: Evidence from Latvian Enterprises}% EN Title
  {Amina Showkath}% EN Student
  {Dr.sc.ing. prof. Andrejs Bondarenko}% EN Supervisor
  {4220 Information Systems (BSc)}% EN Study programme
...
% ---- Meta lists: only List of Tables (has content) ----
\clearpage
